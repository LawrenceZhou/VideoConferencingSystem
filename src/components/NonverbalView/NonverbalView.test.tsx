...
jest.mock('../../hooks/useParticipantsContext/useParticipantsContext', () => () => ({
  NonverbalViewParticipants: mockParticipants,
}));

jest.mock('../../hooks/useNonverbalViewLayout/useNonverbalViewLayout', () =>
  jest.fn(() => ({
...
mockUseAppState.mockImplementation(() => ({ maxNonverbalViewParticipants: 9 }));

describe('the NonverbalView component', () => {
  it('should render correctly', () => {
    const wrapper = shallow(<NonverbalView />);
