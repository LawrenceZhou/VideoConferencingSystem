...
function buildWebGL2Pipeline(
  ...
  var vertexShaderSource = webglHelper_1.glsl(
    templateObject_1 ||
  ...
  var _a = segmentationHelper_1.inputResolutions[segmentationConfig.inputResolution],
    segmentationWidth = _a[0],
    segmentationHeight = _a[1];
  ...
  var resizingStage = resizingStage_1.buildResizingStage(
    gl,
    vertexShader,
    positionBuffer,
    texCoordBuffer,
  ...
  var loadSegmentationStage = loadSegmentationStage_1.buildLoadSegmentationStage(
    gl,
    vertexShader,
    positionBuffer,
    texCoordBuffer,
  ...
  var jointBilateralFilterStage = jointBilateralFilterStage_1.buildJointBilateralFilterStage(
    gl,
    vertexShader,
    positionBuffer,
    texCoordBuffer,
  ...
  var backgroundStage =
    backgroundConfig.type === 'blur'
      ? backgroundBlurStage_1.buildBackgroundBlurStage(
          gl,
          vertexShader,
          positionBuffer,
          texCoordBuffer,
      ...
      : backgroundImageStage_1.buildBackgroundImageStage(
          gl,
          positionBuffer,
          texCoordBuffer,
          personMaskTexture,
