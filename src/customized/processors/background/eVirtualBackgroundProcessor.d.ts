...
/**
 * Options passed to [[eVirtualBackgroundProcessor]] constructor.
 */
export interface eVirtualBackgroundProcessorOptions extends BackgroundProcessorOptions {
  /**
 ...
 * ```
 */
export declare class eVirtualBackgroundProcessor extends BackgroundProcessor {
  private _fitType;
   ...
   */
  constructor(options: eVirtualBackgroundProcessorOptions);
  /**
